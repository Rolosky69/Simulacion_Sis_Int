...
public class Newton : MonoBehaviour
{
    ...
    [SerializeField] Newton Objetivo;
    ...
    {
        MyVector r = Objetivo.transform.position - transform.position;
        float Magnituder = r.magnitude;
        MyVector F = r.normalized * (1 / Objetivo.mass * mass / Magnituder * Magnituder);
